...
| TM-022 | Malicious dependency, CI action, or compromised release                    | Private repository, history/secret scan, full-SHA actions, offline secret-free CI, SBOM, signed whole bundles, independent review, no CI deployment.                                   |
