...
| TM-022 | Malicious dependency, CI action, or compromised release                    | Protected public repository, tree/history secret scans, full-SHA actions, offline secret-free CI, SBOM, signed whole bundles, independent review, no CI deployment.                    |
