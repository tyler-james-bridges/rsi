...
| Mac mini GitHub credential (optional) | Mac mini Keychain/SSH agent                           | Read-only API metadata for the public RSI repository; ordinary clone/fetch needs none  | Push, PR/admin, actions/secrets, private repositories, other repositories                          | Replaceable; never backed up                                                |
...
| ------------------------------------ | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| Release Ed25519 key                  | MacBook fixed Keychain service `dev.rsi.macbook.release-signing`, account `release-ed25519-v1` | Sign one reviewed source/release manifest and whole-bundle identity per ceremony | Sign operator approvals, public artifacts, checkpoints, provider requests; accept caller-selected key paths/services or signer commands | Two separately stored encrypted offline copies; annual exercise/rotation; signed successor transition |
